...
public class FlcFlowinstance: FlcDBEntityTenant
{
    ...
    /// </summary>
    /// <returns></returns>
    [SugarColumn(IsNullable = true, ColumnDataType = "varchar(255)", ColumnDescription = "流程类型")]
    ...
    /// </summary>
    /// <returns></returns>
    [SugarColumn(IsNullable = true, ColumnDataType = "varchar(255)", ColumnDescription = "执行人")]
